...
- **Manufacturer**: Unknown (Stolen Arasaka Tech Base?)
- **Status**: Operational? / Hidden?


### War Machine Specs (If Applicable)
- **Class**: Orbital Directed Energy Weapon
...
- **Operational Status**: Operational? / Hidden?

- **Current Location**: Low Earth Orbit (Undetected?)
...
- **Legal Status**: Weapon of Mass Destruction (Illegal)


- **Common Sources**: Rumors, Fragmented Pre-Collapse Data
