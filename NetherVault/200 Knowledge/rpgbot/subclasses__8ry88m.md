---
url: https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/
archived_at: 2026-04-01T02:58:54.235Z
---
...
This article is for the 2014 DnD 5e rules. For help with the 2024 rules, see our [2024 DnD 5e Fighter Subclasses Guide](https://rpgbot.net/dnd5/characters/classes/2024-fighter/fighter-subclasses/).
...
-   [Fighter Subclasses](#subclasses)
    -   [Arcane Archer (XGtE)](#arcane-archer)
    -   [Battle Master (PHB)](#battle-master)
    -   [Cavalier (XGtE)](#cavalier)
    -   [Champion (PHB)](#champion)
    -   [Echo Knight (EGtW)](#echo-knight)
    -   [Eldritch Knight (PHB)](#eldritch-knight)
    -   [Psi Warrior (TCoE)](#psi-warrior)
    -   [Purple Dragon Knight / Banneret (SCAG)](#purple-dragon-knight)
    -   [Rune Knight (TCoE)](#rune-knight)
    -   [Samurai (XGtE)](#samurai)
...
### [Arcane Archer](https://www.dndbeyond.com/classes/fighter#ArcaneArcher) ([XGtE](/dnd5/abbreviations/))

A really cool concept largely squandered. Arcane Shot is the heart of the subclass, and with just two shots per Short or Loing Rest, you can’t afford to rely on your signature feature often enough for it to be a meaningful part of your character. Arcane Archer gets a couple of excellent features, but they simply don’t compensate for the massive amount of time you’ll spend wishing that you had more Arcane Shot uses.

[Arcane Archer Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/arcane-archer/)

1.  Arcane Archer Lore: A skill proficiency and a cantrip. Choose Prestidigitation and then go read our [Practical Guide to Prestidigitation and Similar Cantrips](/dnd5/characters/prestidigitation).
2.  Arcane Shot: A powerful and versatile featyre, but you get just 2 uses between short rests until you get Ever-Ready Shot at 15th level. A lot of people mis-read the feature’s text: you get additional Arcane Shot _options_, not Arcane Shot _uses_ as you gain levels. Plan to reserve your Arcane Shot uses until doing so is exceptionally beneficial, because you don’t get enough to be careless with them.
    
    This resource constraint was apparently intentional. The designers intended for the shot uses to remain flat, but for the [powers to increase over time](https://twitter.com/mikemearls/status/937496034254536704?ref_src=twsrc%5Etfw) to keep the Arcane Archer consistently powerful. Unfortunately, they forgot the part where the power increases over time, and, since none of the options are restricted by level, you are most powerful relative to your enemies at level 3 and only diminish in effectiveness from there.
    ...
    -   Grasping Arrow: Bonus damage and a speed debuff with ongoing damage. The target can waste its action to _attempt_ to remove the brambles, but, even if they succeed, they’ve wasted their Action for a turn, which is a trade that you should be very happy to make.
...
### [Battle Master](https://www.dndbeyond.com/classes/fighter#BattleMaster) ([PHB](/dnd5/abbreviations/))
...
[Battle Master Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/battle-master/)
...
2.  Student of War: Artisan’s tools probably won’t matter to the game, but the expanded options in Xanathar’s Guide to Everything make this much more fun than it was when the core rules were published. Check out out [Practical Guide to Tools](https://rpgbot.net/dnd5/characters/tools/).
...
### [Cavalier](https://www.dndbeyond.com/classes/fighter#Cavalier) ([XGtE](/dnd5/abbreviations/))
...
[Cavalier Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/cavalier/)
...
### [Champion](https://www.dndbeyond.com/classes/fighter#Champion) ([PHB](/dnd5/abbreviations/))
...
[Champion Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/champion/)
...
### [Echo Knight](https://www.dndbeyond.com/classes/fighter#EchoKnight) ([EGtW](/dnd5/abbreviations/))
...
### [Eldritch Knight](https://www.dndbeyond.com/classes/fighter#EldritchKnight) ([PHB](/dnd5/abbreviations/))
...
While the Eldritch Knight is fantastically durable and plenty effective, they usually can’t compete offensively with the [Hexblade Warlock](https://rpgbot.net/dnd5/characters/classes/warlock/subclasses/hexblade/) or the [Bladesinger Wizard](https://rpgbot.net/dnd5/characters/classes/wizard/bladesinging/), both of which have considerably better spellcasting options but are nowhere near so capable of surviving in melee for extended periods.
...
[Eldritch Knight Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/eldritch-knight/)
...
-   Spellcasting: Spellcasting is what defines the Eldritch Knight. You’re limited almost entirely to Abjuration and Evocation spells, but those offer plenty of options which work for a Fighter. Be sure to pick up an offensive cantrip like Booming Blade which you can use alongside weapon attacks with War Magic.
    ...
    You’ll get just one spell of each spell level which isn’t restricted to Abjuration/Evocation, so be _very_ careful when picking those spells.
    
    For help selecting spells, see our [Fighter Spell List Breakdown](/dnd5/characters/classes/fighter/spells).
...
### [Psi Warrior](https://www.dndbeyond.com/classes/fighter#PsiWarrior) ([TCoE](/dnd5/abbreviations/))
...
[Psi Warrior Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/psi-warrior/)
...
### [Purple Dragon Knight / Banneret](https://www.dndbeyond.com/classes/fighter#PurpleDragonKnight) ([SCAG](/dnd5/abbreviations/))
...
[Puple Dragon Knight Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/purple-dragon-knight/)

1.  Rallying Cry: This isn’t a ton of healing, but it doesn’t need to be. This is effectively Mass Healing Word with a few restrictions in exchange for it not being a spell. It does affect unconscious allies, as [the Unconscious condition was not intended to deafen creatures](https://youtu.be/u67o2kE6InA?t=1352) according to Jeremy Crawford.
...
### [Rune Knight](https://www.dndbeyond.com/classes/fighter#RuneKnight) ([TCoE](/dnd5/abbreviations/))
...
[Rune Knight Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/rune-knight/)
...
3.  Giant’s Might: Similar to casting Enlarge/Reduce as a Bonus Action, though the damage bonus isn’t as good. Being large makes it harder for enemies to get around you since you take up more space, and Advantage on Strength checks makes it very easy to use Athletics to Shove and Grapple your enemies.
    ...
    The precise wording in the feature is important. If you are not Large or larger, your size becomes Large. This is important because Enlarge/Reduce cast upon the Rune Knight _after_ using Giant’s Might further increases the knight to Huge size, but not if Enlarge/Reduce is cast beforehand.
...
### [Samurai](https://www.dndbeyond.com/classes/fighter#Samurai) ([XGtE](/dnd5/abbreviations/))
...
[Samurai Fighter Handbook](https://rpgbot.net/dnd5/characters/classes/fighter/subclasses/samurai/)
...
5.  Rapid Strike: Advantage is nice because you get to roll twice and keep the higher. Rapid Strike lets you keep _both_, so if you get lucky and both rolls are high you can hit twice. You only get to do this once per turn, but this means that you can get four attacks in a single turn (5 once you hit 20th level, more if you have Haste, use Two-Weapon Fighting, activate Action Surge, etc.).
