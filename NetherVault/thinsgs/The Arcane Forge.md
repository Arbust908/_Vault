...
###### Essence as a Goal
> "I'm in my tower studying how to craft a *Carpet of Flying*," says Anna.
> "Other than having a carpet to enchant, and the gems and herbs you'll need, you think you'll need the essence of some creature that has a fly speed and can hover," replies the GM, setting a goal for her to achieve.
...
#### Rare Metal Ingots
To create weapons or armor from rare metal, you need ingots of that metal. 

The cost and rarity of each type of ingot are listed on the Rare Metal table, and the number of ingots required is on the Required Ingots table.
...
Crafting an item from a rare metal takes as long as crafting a magic item of that same rarity, plus the mundane crafting time of the item itself.

As a rule of thumb, rare metal ingots are at their best when they’re treated as rewards to be discovered rather than as materials to be purchased. 

The party could find stacks of adamantine in a dwarven ruin, or a single bar of mithral preserved in an old elvish vault. In this case, the cost of the ingot listed above is irrelevant.

###### Finding an Arcane Forge
To create weapons or armor out of very rare or legendary metals, you must be working the metal at an arcane forge.

Where you can find such a forge is up to the GM. Perhaps it’s found in a vast metropolis where magic items are more common, and access to the forge carefully controlled. Or maybe it’s deep within a dungeon where it lies dormant, waiting to be rediscovered and for its flames to be kindled once more.
...
#### Rare Metal Alloy
When creating a new magic weapon or armor with a rare metal, you can attempt to combine the two metals into a powerful alloy. When you do, you use the more powerful Magic Weapon or Magic Armor property and add all other properties of both metals to the weapon.
...
###### No Stacking
Multiple instances of the same enchantment, or features with the same name (such as "extra damage") do not stack.
...
### Spellcasting Enchantments
You can enchant an item to be able to cast spells.

###### One Spellcasting Property
A magic item can only have one spellcasting enchantment. When you put a new spellcasting enchantment on an item it replaces the previous one.

###### Spellcasting Charges
Rarer spellcasting properties use charges to determine how they work. You can cast each spell by spending a number of charges equal to the level of the spell being cast. 

#### Spellcasting Properties
Choose one of the following to determine both the rarity of the item and  how its spellcasting property works.

###### Uncommon Spellcasting
You choose a spell of either 1st or 2nd level. This item can now cast that spell once before it needs to recharge at the next dawn.

###### Rare Spellcasting
You choose no more than four spells of 3rd level or lower. You spend charges to cast these spells. This item has 5 charges and regains 1d4 + 1 charges at dawn.

###### Very Rare Spellcasting
You choose no more than six spells of 5th level or lower. You spend charges to cast these spells. This item has 10 charges and regains 2d6 + 4 charges at dawn.

###### Legendary Spellcasting
You choose no more than ten spells of 7th level or lower. You spend charges to cast these spells. This item has 20 charges and regains 2d8 + 4 charges at dawn.
...
###### Flame Tongue
You can use a bonus action to wreathe this weapon in flames. While wreathed in flames the weapon gains the following features.
***Light.*** The weapon sheds Bright Light in a 20-foot radius and Dim Light for an additional 20 ft. 
***Extra Damage.*** The weapon deals an extra 2d6 fire damage on a hit.

###### Frost Brand
This weapon has the following properties:
***Extra Damage.*** This weapon deals an extra 1d6 cold damage on a hit.
***Cold Resistance.*** You gain resistance to fire damage while you are attuned to it.
***Light.*** While in freezing temperatures the weapon sheds Bright Light in a 20-foot radius and Dim Light for an additional 20 ft.
***Cold Winds.**** When you draw this weapon, you can extinguish all nonmagical flames within 30 feet of yourself. Once used, this property can’t be used again for 1 hour.

###### Holy Avenger
This weapon has the following properties:
***Extra Damage.*** When you hit a Fiend or Undead with this weapon it takes 2d10 radiant damage. 
***Aura.** While you hold the drawn weapon, it creates a 10-foot Emanation originating from you. You and all creatures friendly to you in the emanation have advantage on saving throws against spells and other magical effects.
...
###### Mind Breaker
This weapon has the following properties.
***Extra Damage.*** This weapon deals an extra 1d6 psychic damage on a hit.
***Mind Breaker.*** A creature that takes damage from this weapon has disadvantage on the next Intelligence, Wisdom or Charisma saving throw it makes before the end of its next turn.
...
###### Primordial
This weapon is imbued with the power of the outer planes. When you create this weapon choose a type of damage from the table, or roll randomly. 
***Extra Damage.*** The weapon deals an extra 1d8 damage of the chosen type on a hit.
...
###### Ruin
This weapon has the following propreties.
***Extra Damage.*** The weapon deals an extra 2d8 lightning damage on a hit. 
***Undaunted.*** While attuned to this weapon, you are immune to being charmed or frightened.
...
###### Skin Melter
This weapon has the following propreties.
***Extra Damage.*** The weapon deals an extra 1d10 acid damage on a hit.  
***Skin Melter.*** A creature that takes damage from this weapon becomes Frightened of the wielder until the end of its next turn.
...
###### Swatting
When creating a swatting weapon you determine what creature type it’s designed to swat, or roll randomly on the Creature Type table.
***Extra Damage.*** This weapon deals an extra 2d6 damage to creatures of the chosen type. 
***Swatter.*** When a creature of the chosen type takes damage from this weapon that leaves it with 10 hit points or fewer, it is reduced to 0 hit points.


###### Thunderbolt
This weapon has the following properties:
***Extra Damage.*** When you hit a creature with this weapon it takes an extra 2d8 thunder damage.
Thunderous Boom. On a hit, you can choose to take a bonus action to have the weapon emit a thunderous boom. If you do, the target and every creature within 30 feet of it other than you must succeed on a DC 17 Constitution saving throw or be Stunned until the end of your next turn. 
...
###### Vicious
This weapon has the following properties.
***Extra Damage.*** The weapon deals an extra 2d6 damage of the weapon's type on a hit.  
...
###### Withering
This weapon has the following properties.
***Extra Damage.*** This weapon deals an extra 1d6 necrotic damage on a hit.
***Withering.*** A creature that takes damage from this weapon has disadvantage on the next Strength, Dexterity or Constitution saving throw it makes before the end of its next turn.

###### Wounding
This weapon has the following properties.
***Extra Damage.*** This weapon deals an extra 2d6 necrotic damage on a hit.
***Wounding.*** A creature that takes damage from this weapon must succeed on a DC 15 Constitution saving throw or be unable to regain hit points for 1 hour. The target repeats the save at the end of each of its turns, ending the effect on itself on a success.
...
###### Credits
**Creative Director:** Daði Einars 
**Lead Designer:** Magnús Fr. 
**Art Director:** Brimrún Birta 
**Production & Layout:** Anna Birna

###### Legal Disclaimer
This work includes material from the System Reference Document 5.2.1 (“SRD 5.2.1”) by Wizards of the Coast LLC, available at [https://www.dndbeyond.com/srd](https://www.dndbeyond.com/srd "https://www.dndbeyond.com/srd"). The SRD 5.2.1 is licensed under the Creative Commons Attribution 4.0 International License, available at [https://creativecommons.org/licenses/by/4.0/legalcode](https://creativecommons.org/licenses/by/4.0/legalcode "https://creativecommons.org/licenses/by/4.0/legalcode").