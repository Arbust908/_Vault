...
This chapter contains a variety of play aids, including conversion notes to use Basic Roleplaying with other Chaosium Inc. games, an afterword,
a bibliography of sources consulted, character sheets, references, and tables presented for convenience.

### Conversion Notes

Here are conversion notes for using _Basic Roleplaying_ with other Chaosium Inc.. games such as _Call of Cthulhu_ or _RuneQuest_.
- Magic points are power points in this version, to be more thematically appropriate for mutations, psychic abilities, and superpowers.
- In other Basic Roleplaying-based games, Charisma (CHA) has been Appearance (APP).
- Characteristic rolls have been introduced for all characteristics.
- Many rules from other Basic Roleplaying games have been made optional, to streamline gameplay and make this set of rules suitable for all genres, with the level of complexity set by the gamemaster.
- Skills have seen the most change. The following table shows the skill titles that have been changed. Information and science-based skills have changed the most dramatically, and many have been subsumed into the Knowledge or Science skills. If a skill is not on this table, the title has remained the same (or essentially unchanged) throughout all iterations of this system. This list deals only with the core Basic Roleplaying game lines, and skills specific to a particular setting are not included.

```
Basic Roleplaying Skill Equivalent Skill Names
Appraise Evaluate, Evaluate Treasure
Art (various) Fine Arts, Photography
Artillery (various) Weapons System
Brawlw Fist, Fist/Punch, Head Butt, Kick, Unarmed Combat
Craft (various) Build
Drive (various) Ground Vehicle
Energy Weapon (various) Handgun: Energy
Fine Manipulation Devise, Lock Picking, Locksmith, Pick Lock, Set Trap, Tie
Knot, Trap Set/Disarm
Firearm (various) Archaic Ranged Weapon, Handgun, Handgun: Projectile,
Rifle, Shotgun, Submachine Gun
First Aid Emergency Treatment, Healing Lore, Physik
Fly Personal Flyer
```

BASIC ROLEPLaYING SYSTEM

Heavy Machine (various) Operate Heavy Machine

Heavy Weapon (various) Heavy Weapon: Energy, Heavy Weapon: Projectile, Machine
Gun

Hide Camouflage, Conceal, Hide in Cover

Insight Psychology

Jump Jumping

Knowledge (various) Accounting, Animal Lore, Anthropology, Archaeology,
Astrological Lore, Botany, Business, Computer Use,
Criminology, Farming, Hermetic Lore, History, Hunt, Law,
Linguist, Music Lore, Natural World, Occult, Plant Lore,
Poison Lore, Religion, Streetwise, Survival, Theology

Language (specific) Second Languages, Speak

Literacy (optional) Read Own Language, Read/Write, Scribe

Medicine Diagnose Disease, Pharmacy, Potions, Treat Disease, Treat
Poison

Melee Weapon (various) Archaic Melee Weapon, Melee

Navigate Cartography, Make Map, Map Making

Perform Musicianship, Play Instrument, Orate, Oratory, Sing

Persuade Communication, Debate

Pilot (various) Aquatic Vehicle, Atmospheric Craft, Boat, Drive Horses,
Hyperdrive, Reaction Drive, Reactionless Drive, Sailing,
Shiphandling

Psychotherapy Psychoanalyze

Repair (various) Electrical Repair, Mechanical Repair, Repair/Devise, Trap

Research Computer Use, Library Use

Ride (various) Ride Horses, Riding

Science (various) Astronomy, Biological Lore, Biology, Chemical Lore,
Chemistry, Geology, Mineral Lore, Physics, Planetology,
Zoology

Sense Perception, Scent, Scent/Taste, Smell, Taste

Sleight of Hand Conceal Object, Cut Purse, Hide Item, Juggle, Pick Pocket,
Sleight

Spot Observation, Perception, Scan, Scrutinize, Search, See,
Spot Hidden Item, Spot Hidden Object, Spot Trap

Status Credit, Credit Rating

Stealth Ambush, Move Quietly, Move Silently, Sneak

Swim Swimming

Technical Skill (various) Computer Use, Computers, Electrical Lore, Electronics,
Locksmith, Mechanical Lore, Mechanics
...
Additionally, certain skills have been replaced by characteristic rolls.

```
Characteristic Roll Old Skill
Idea (INT×5) Memorize
Agility (DEX×5) Athletics, Balance, Tumble
Know (EDU×5) Human Lore, World Lore
```
