...
- **Manufacturer**: Unknown (AI Research Project?)
- **Status**: Active / Rogue?


### War Machine Specs (If Applicable)
- **Class**: Networked Defense System
...
- **Operational Status**: Active / Rogue?

- **Current Location**: Variable (Deployed across districts/facilities)
...
- **Legal Status**: Highly Illegal Autonomous Weapon System


- **Common Sources**: Rogue AI Incidents, Abandoned Smart Cities
