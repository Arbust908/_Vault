...
- **Category**: Autonomous Artillery
- **Rarity**: Legendary
- **Manufacturer**: Unknown (Likely Zetatech or competitor)
- **Status**: Operational (Rare)


### War Machine Specs (If Applicable)
- **Class**: Anti-Personnel Energy Weapon
...
- **Operational Status**: Operational (Rare)

- **Current Location**: Fortified Positions, Automated Defenses
...
- **Street Price**: Not Applicable


- **Availability**: Extremely Rare


- **Legal Status**: Highly Illegal (Inhumane Weapon)


- **Common Sources**: Black Sites, Pre-Collapse Military Bases
