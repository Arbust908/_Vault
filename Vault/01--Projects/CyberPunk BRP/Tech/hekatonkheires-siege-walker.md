...
- **Manufacturer**: Unknown (Likely custom or heavily modified)
- **Status**: Unknown


### War Machine Specs (If Applicable)
- **Class**: Siege Mech / Demolition Platform
...
- **Current Location**: Unknown (Deep Ruins?)
...
- **Legal Status**: Military Prototype (Illegal)


- **Common Sources**: Pre-Collapse Skunkworks, Hidden Arsenals
