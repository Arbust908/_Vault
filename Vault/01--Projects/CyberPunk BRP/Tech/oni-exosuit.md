...
- **Category**: Corporate Special Ops Exosuit
- **Rarity**: Legendary
- **Manufacturer**: Unknown (Arasaka Advanced Projects?)
- **Status**: Prototype / Limited Deployment


### Powered Armor Specs (If Applicable)
- **Class**: Stealth Assault Armor
...
- **Operational Status**: Prototype / Limited Deployment

- **Current Location**: Corporate Black Sites, Spec Ops Armories
...
- **Legal Status**: Military Grade / Corporate Secret (Illegal)


- **Common Sources**: Defected Spec Ops, Raided Corp Facilities
