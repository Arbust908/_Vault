...
- **Category**: Submersible Energy Weapon
- **Rarity**: Legendary
- **Manufacturer**: Unknown (Oceanic Corp?)
- **Status**: Unknown (Dormant?)


### War Machine Specs (If Applicable)
- **Class**: Area Denial / Energy Weapon Platform
...
- **Operational Status**: Unknown (Dormant?)

- **Current Location**: Deep Sea / Coastal Power Conduits
...
- **Legal Status**: Weapon of Mass Disruption (Illegal)


- **Common Sources**: Pre-Collapse Naval Bases, Deep Sea Wreckage
