...
### [Provide the necessary context](#provide-the-necessary-context)
...
### [Set explicit goals and requirements](#set-explicit-goals-and-requirements)
...
### [Continually refine your prompts](#continually-refine-your-prompts)
...
### [Assign agentic tasks](#assign-agentic-tasks)
...
## [For developers building coding agents via the xAI API](#for-developers-building-coding-agents-via-the-xai-api)
...
### [Use native tool calling](#use-native-tool-calling)
...
### [Give a detailed system prompt](#give-a-detailed-system-prompt)
...
### [Introduce context to the model](#introduce-context-to-the-model)
...
### [Optimize for cache hits](#optimize-for-cache-hits)
